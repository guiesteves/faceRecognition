...
parser = argparse.ArgumentParser(
    description='Create a face dataset from youtube video.')
...
start()
saveFacesInFolder()
# python createDataset.py https://www.youtube.com/watch?v=2DAIe1SlLMo atila/ atila
# python createDataset.py https://www.youtube.com/watch?v=YJAjJtgiZSI raphael/ raphael
# python createDataset.py https://www.youtube.com/watch?v=7VxQQW_eq_A arthur/ arthur
# python createDataset.py https://www.youtube.com/watch?v=0IIJg8Y8skA kin/ kin
